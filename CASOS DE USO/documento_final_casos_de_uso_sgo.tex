...
\fancyhead[R]{\small\color{darkGray}Óptica Vista Visión}
...
\begin{titlepage}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{0.45\textwidth}
            \centering
            % IMAGEN: Logotipo de Óptica Vista Visión
            % Guardar como: pictures/logo_vista_vision.png en Overleaf
            \includegraphics[height=2.0cm]{pictures/logo_vista_vision.png}
        \end{minipage}
    \end{figure}
...
\hline
\rowcolor{lightGray}\textbf{Empresa / Organización:} & Óptica Vista Visión --- Riobamba, Ecuador \\
\hline
...
\hline
\textbf{Cliente / Stakeholder:} & Optometrista Propietario de Óptica Vista Visión \\
\hline
...
\hline
Lic. Optometrista Titular & Propietario / Cliente & Óptica Vista Visión & 25/09/2026 & [Aprobado] \\
\hline
\end{tabularx}
...
\hline
\textbf{Descripción:} & Genera la receta médica con membrete institucional de Óptica Vista Visión, código QR de verificación de autenticidad, diagnóstico CIE-10 (H52.2 Astigmatismo) y firma profesional. \\
\hline
\end{tabularx}
\end{table}
...
\begin{minipage}{0.48\textwidth}
    ...
    \small Representante Óptica Vista Visión
\end{minipage}
